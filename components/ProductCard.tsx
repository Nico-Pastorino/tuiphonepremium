...
export function ProductCard({ product, variant = "default", showQuickActions = true }: ProductCardProps) {
  ...
  const cardVariants = {
    default:
      "group relative overflow-hidden bg-white border-0 shadow-sm hover:shadow-2xl transition-all duration-500 rounded-2xl",
    compact:
      "group relative overflow-hidden bg-white border border-gray-200 hover:shadow-lg transition-all duration-300 rounded-xl",
    featured:
      "group relative overflow-hidden bg-gradient-to-br from-blue-50 to-purple-50 border-0 shadow-lg hover:shadow-2xl transition-all duration-500 rounded-3xl",
  }
    ...
    >
      <CardContent className="p-0">
        ...
        <div className="relative aspect-square overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100 rounded-t-2xl">
          ...
          {showQuickActions && (
            ...
            >
              ...
              >
                <GitCompare className={cn("w-4 h-4", isInCompare(product.id) ? "text-blue-500" : "text-gray-600")} />
              </Button>
        ...
        <div className="p-4 lg:p-6">
          ...
          {/* Title */}
          <Link href={`/productos/${product.id}`}>
            <h3 className="font-bold text-lg lg:text-xl mb-3 text-gray-900 leading-tight line-clamp-2 group-hover:text-blue-600 transition-colors">
              {product.name}
            </h3>
          </Link>
          ...
          <div className="flex gap-3">
            ...
            <Button
              variant="outline"
              className="px-4 py-3 rounded-2xl border-2 border-gray-200 hover:border-green-300 hover:bg-green-50 transition-all duration-300 bg-transparent"
              asChild
            >

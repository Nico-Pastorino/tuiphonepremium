...
export const INSTALLMENTS_CONFIG_CACHE_TAG = "installments-config"
...
export const getInstallmentConfigCached = unstable_cache(loadInstallmentConfig, ["installments-config"], {
  revalidate: DEFAULT_CONFIG_TTL_SECONDS,
  tags: [INSTALLMENTS_CONFIG_CACHE_TAG],
})
...
export const invalidateInstallmentConfigCache = async (): Promise<void> => {
  await revalidateTag(INSTALLMENTS_CONFIG_CACHE_TAG)
}
